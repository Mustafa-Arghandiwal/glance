        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <form action={formAction}>
                <FieldGroup>
                    <div className="flex flex-col items-center gap-2 text-center">
                        ...
                        >
                            <div className="flex   items-center justify-center rounded-md">
                                <Image src="/glance-logo.png" alt="glance" width={431} height={396} className="w-20 h-auto" loading="eager" />
                            </div>
                            <span className="sr-only">Glance</span>
                        </Link>
                        <h1 className="text-xl font-bold">Welcome to Glance</h1>
                        <FieldDescription>
                    ...
                    <Field>
                        <Button type="submit" disabled={isPending} className="disabled:opacity-50 cursor-pointer">Create Account</Button>
                        {state.message && (
                            <p className="text-xs text-red-400">
                                {state.message}
                            </p>
